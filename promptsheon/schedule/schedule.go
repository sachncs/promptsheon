...
// New constructs a Schedule. Returns errs.ErrInvalidCron when the kind
...
// errs.ErrInvalidCron signals an unparseable cron expression.

// Validate returns errs.ErrInvalidCron if cron is empty or unparseable.
...
// and produce errs.ErrInvalidCron. The parsing is deliberate: full cron
...
// errs.ErrInvalidCron so callers can errors.Is against the sentinel.
...
func splitCSV(s string) []string { return stringsutil.SplitCSV(s) }
