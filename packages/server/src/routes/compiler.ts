...
function buildManifestFromPrompt(prompt: string): Manifest {
  ...
  return {
    ...
    model: { provider: 'anthropic', modelId: 'claude-sonnet', temperature: 0.2, topP: 1, maxTokens: 1024 },
    runtime: { timeoutMs: 30_000, nodeTimeoutMs: 30_000, totalTimeoutMs: 30_000, maxRetries: 1, canaryPercent: 0, concurrencyLimit: 1 },
