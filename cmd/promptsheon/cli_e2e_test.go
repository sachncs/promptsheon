...
func TestMain(m *testing.M) {
	...
	cmd := exec.Command("go", "build", "-o", cliBinary, "./cmd/promptsheon")
	cmd.Dir = repoRoot()
...
// repoRoot walks up to find go.mod. The build needs to run
// from the module root so ./cmd/promptsheon resolves.
