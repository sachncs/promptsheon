...
func makeTest(id string) *backend.Test {
	return &backend.Test{
		ID:       id,
		Name:     "Test " + id,
		PromptID: "prompt1",
...
func TestRecordResult(t *testing.T) {
	...
	// Record some results
	for i := 0; i < 10; i++ {
		engine.RecordResult("test1", "v1", true, backend.ResultMetrics{LatencyMs: 100, Tokens: 50, Cost: 0.001})
	}
...
func TestListTests(t *testing.T) {
	...
	_ = engine.CreateTest(&backend.Test{
		ID:       "test1",
		Name:     "Test 1",
		PromptID: "prompt1",
		Variants: []*backend.Variant{{ID: "v1", TrafficPct: 100}},
	})
...
func TestRecordResultMixedSuccessAndFailure(t *testing.T) {
	...
	for i := 0; i < 7; i++ {
		engine.RecordResult("mixed", "v1", true, backend.ResultMetrics{LatencyMs: 100, Tokens: 50, Cost: 0.001})
	}
	for i := 0; i < 3; i++ {
		engine.RecordResult("mixed", "v1", false, backend.ResultMetrics{LatencyMs: 100, Tokens: 50, Cost: 0.001})
	}
...
func TestRecordResultNonexistentVariant(_ *testing.T) {
	...
	engine.RecordResult("rrtest", "nonexistent", true, backend.ResultMetrics{LatencyMs: 100, Tokens: 50, Cost: 0.001})
}
...
func TestGetResultsLatencyCriteria(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		engine.RecordResult("lat-test", "fast", true, backend.ResultMetrics{LatencyMs: 10, Tokens: 50, Cost: 0.001})
		engine.RecordResult("lat-test", "slow", true, backend.ResultMetrics{LatencyMs: 500, Tokens: 50, Cost: 0.001})
	}
...
func TestGetResultsCostCriteria(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		engine.RecordResult("cost-test", "cheap", true, backend.ResultMetrics{LatencyMs: 100, Tokens: 50, Cost: 0.001})
		engine.RecordResult("cost-test", "expensive", true, backend.ResultMetrics{LatencyMs: 100, Tokens: 50, Cost: 0.100})
	}
...
func TestGetResultsSuccessRateCriteria(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		engine.RecordResult("sr-test", "good", true, backend.ResultMetrics{LatencyMs: 100, Tokens: 50, Cost: 0.001})
		engine.RecordResult("sr-test", "bad", false, backend.ResultMetrics{LatencyMs: 100, Tokens: 50, Cost: 0.001})
	}
...
func TestGetResultsConfidenceClamped(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		engine.RecordResult("conf-test", "v1", true, backend.ResultMetrics{LatencyMs: 100, Tokens: 50, Cost: 0.001})
	}
