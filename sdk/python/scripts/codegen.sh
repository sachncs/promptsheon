...
#
# Regenerates sdk/python/src/promptsheon/ from
# backend/spec/spec.yaml using openapi-python-client. Run this
# whenever the spec changes. CI verifies the package imports
# cleanly via 'python -m compileall'.
set -euo pipefail
cd "$(dirname "$0")/.."
