  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        destructive: 'bg-destructive text-white shadow-1 hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60',
        outline: 'border border-border-subtle bg-surface-1 hover:bg-surface-2 hover:text-text-strong',
        secondary: 'bg-secondary text-secondary-foreground shadow-1 hover:bg-secondary/80',
        ghost: 'hover:bg-surface-2 hover:text-text-strong',
        link: 'text-brand underline-offset-4 hover:underline',
        subtle: 'border border-border-subtle bg-surface-2 text-text-default hover:bg-surface-3',
      },
      size: {
