...
is a fourth surface — it lives in [docs/security.md](../security/security.md)
...
`promptsheon/metrics` package. The full inventory:
...
| `promptsheon_trace_dropped_total` | counter | Spans dropped; reserved (currently no producer). |
...
See [docs/security.md](../security/security.md#audit-chain) for the chain
