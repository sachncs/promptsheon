...
- [`docs/development/faq.md`](../development/faq.md) — top-of-mind questions.
- [`docs/development/development.md`](../development/development.md) — local-dev workflow.
- [`docs/security/security.md`](../security/security.md) — threat model + auth
  + audit chain.