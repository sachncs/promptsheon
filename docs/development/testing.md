...
| Vulnerability scan | `../security/security.md` (govulncheck + gosec) | every PR + master |
...
- [docs/slos.md](../operations/slos.md) — SLO targets + the RPO / RTO
  table that motivates the chaos + smoke layers.
- [docs/architecture.md](../architecture/architecture.md) — the package
