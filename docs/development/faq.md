...
See [docs/algorithms.md](../architecture/algorithms.md) for the
...
[docs/deployment.md](../operations/deployment.md) (Helm chart, Docker
image, systemd units).
...
See [docs/security.md](../security/security.md#audit-chain) for the
retention contract.
