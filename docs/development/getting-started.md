...
See [docs/configuration.md](../operations/configuration.md) for the full
...
(see [docs/algorithms.md](../architecture/algorithms.md#content-addressed-storage)).
...
See [docs/harness.md](../reference/harness.md) and [docs/eval.md](../reference/eval.md) for
the full surface.
...
See [docs/observability.md](../operations/observability.md) and
[docs/slos.md](../operations/slos.md) for the metric inventory and the three
first-class SLOs.
...
- **`./promptsheond` exits with "PROMPTSHEON_AUTH=false is only
  ...
  `PROMPTSHEON_TLS_KEY_FILE`. See [docs/security.md](../security/security.md).
...
See [docs/troubleshooting.md](../operations/troubleshooting.md) for the full
checklist.