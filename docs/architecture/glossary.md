...
Optional artifacts: `../reference/guardrails.md` (Guardrail references),
...
The promptsheon/cas/ package. Every artifact is a content-addressed
...
(`promptsheon/optimizer`) or the bandit selector
(`promptsheon/bandit`). Recommendations are stored with a
...
the project. See [docs/slos.md](../operations/slos.md).
