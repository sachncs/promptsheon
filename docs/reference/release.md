...
- [docs/getting-started.md](../development/getting-started.md) — the
  walkthrough that exercises the lifecycle end-to-end.
- [docs/security.md](../security/security.md) — the audit chain
  contract.
- [docs/architecture.md](../architecture/architecture.md) — the Release
