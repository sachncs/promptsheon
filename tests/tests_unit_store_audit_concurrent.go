...
// RunAppendAuditConcurrentChainPreserved hammers AppendAudit
...
func RunAppendAuditConcurrentChainPreserved(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
...
// RunAppendAuditCacheReadThrough verifies the read-through
...
func RunAppendAuditCacheReadThrough(t *testing.T) {
	t.Parallel()
	dir := t.TempDir()
...
func RunAppendAuditInterleavedHandles(t *testing.T) {
	t.Parallel()
