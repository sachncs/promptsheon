...
func RunRecordRejectsEmptyIdentity(t *testing.T) {
	t.Parallel()
	a := Approval{}
...
func RunRecordRejectsUnknownDecision(t *testing.T) {
	t.Parallel()
	a := Approval{}
...
func RunRecordRejectsDuplicateIdentity(t *testing.T) {
	t.Parallel()
	a := Approval{}
...
func RunRecordAppends(t *testing.T) {
	t.Parallel()
...
func RunMajorityPolicy(t *testing.T) {
	t.Parallel()
...
func RunMajorityPolicyRejectHalts(t *testing.T) {
	t.Parallel()
	pol := MajorityPolicy{Required: 2}
...
func RunMajorityPolicyRejectsNonPositiveRequired(t *testing.T) {
	t.Parallel()
...
func RunMakerCheckerRequiresSeparation(t *testing.T) {
	t.Parallel()
