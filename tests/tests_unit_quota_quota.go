...
func RunNewRejectsNonPositiveLimit(t *testing.T) {
	t.Parallel()
...
func RunNewRejectsUnknownScope(t *testing.T) {
	t.Parallel()
...
func RunNewRejectsUnknownWindow(t *testing.T) {
	t.Parallel()
...
func RunChargeUnderLimitAdvances(t *testing.T) {
	t.Parallel()
...
func RunChargeResetsWindow(t *testing.T) {
	t.Parallel()
