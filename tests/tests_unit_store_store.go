...
// RunScheduleCRUD is the only caller today; other tests that
...
func RunNewSQLiteAndClose(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
...
// RunMergeSystemConfigPersistsWinner pins SETTINGS-CRDT-1: a
...
// the winner.
func RunMergeSystemConfigPersistsWinner(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
...
func RunNewSQLiteRunsAllMigrations(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
...
func RunUserRoundTrip(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
...
func RunAPIKeyRoundTrip(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
...
func RunAppendAndVerifyAuditChain(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
...
// RunAuditVerifyCacheInvalidatedOnAppend pins PERF-AUDIT-2:
...
func RunAuditVerifyCacheInvalidatedOnAppend(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
...
func RunAuditChainDetectsTampering(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
...
func RunListAuditFilters(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
...
func RunCapabilityVersionLifecycle(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
	now := time.Now().UTC()
...
func RunProviderKeyRoundTrip(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
	now := time.Now().UTC()
...
func RunWebhookEndpointRoundTrip(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
	now := time.Now().UTC()
...
// RunWebhookSecretCiphertextOnDisk exercises SEC-7a: the
...
func RunWebhookSecretCiphertextOnDisk(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
	now := time.Now().UTC()
...
func RunScheduleCRUD(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
	now := time.Now().UTC()
...
// RunAuditChainDetectsTailDeletion exercises DB-7 / SEC-CHAIN-1:
...
func RunAuditChainDetectsTailDeletion(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
...
// by RunAuditChainReturnsStructuredResult elsewhere; this helper
...
// RunAuditChainReturnsStructuredResult locks in OBS-AUDIT-3:
// VerifyAuditChain returns an AuditVerifyResult with the
// expected fields populated.
func RunAuditChainReturnsStructuredResult(t *testing.T) {
	t.Parallel()
	s := newTestSQLite(t)
	ctx := context.Background()
	for i := 0; i < 3; i++ {
