...
func RunContractValid(t *testing.T) {
	t.Parallel()
...
func RunContractEmptyIsError(t *testing.T) {
	t.Parallel()
...
func RunContractInvalidBlastRadius(t *testing.T) {
	t.Parallel()
...
func RunContractSuccessRateRange(t *testing.T) {
	t.Parallel()
...
func RunContractHallucinationRateRange(t *testing.T) {
	t.Parallel()
	for _, rate := range []float64{-0.1, 1.1, 2.0} {
...
func RunContractCanAutoAdoptLow(t *testing.T) {
	t.Parallel()
	c := CapabilityContract{
		BlastRadius: BlastLow,
...
func RunContractCanAutoAdoptMediumRequiresOpt(t *testing.T) {
	t.Parallel()
...
func RunContractCanAutoAdoptHighRequiresOpt(t *testing.T) {
	t.Parallel()
...
func RunContractCanAutoAdoptInvalidIsFalse(t *testing.T) {
	t.Parallel()
	c := CapabilityContract{
		BlastRadius: "wat",
		SLOTarget:   SLOTarget{MaxP95LatencyMS: 1000},
...
func RunBlastRadiusValid(t *testing.T) {
	t.Parallel()
