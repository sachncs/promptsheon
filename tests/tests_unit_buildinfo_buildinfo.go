...
func RunGetReturnsAllFields(t *testing.T) {
	info := Get()
...
func RunGetIsJSONSerializable(t *testing.T) {
...
// RunDomainPurityScriptExists pins PURITY-1: the
...
// was violated.
func RunDomainPurityScriptExists(t *testing.T) {
