...
func RunContinuousEvalDisabledWithZeroInterval(t *testing.T) {
...
func RunContinuousEvalRunOnceNoActiveRelease(t *testing.T) {
	repo := harnessrepo.New()
	c := harness.NewContinuousEval(harness.ContinuousEvalConfig{
		CapabilityID: "c1",
		DatasetID:    "d1",
...
func RunContinuousEvalRunOnceWithActiveReleaseAndDataset(t *testing.T) {
	repo := harnessrepo.New()
...
func RunContinuousEvalStartTwiceOrAfterStop(t *testing.T) {
	repo := harnessrepo.New()
	c := harness.NewContinuousEval(harness.ContinuousEvalConfig{
		CapabilityID: "c1",
		Interval:     0,
...
func RunContinuousEvalDefaultScorer(t *testing.T) {
