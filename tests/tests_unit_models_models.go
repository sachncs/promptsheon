...
func RunUserJSONRoundTrip(t *testing.T) {
	t.Parallel()
...
func RunAPIKeyKeyHashHidden(t *testing.T) {
	t.Parallel()
	k := models.APIKey{
		ID:        "k1",
		UserID:    "u1",
...
func RunAPIKeyOptionalFieldsOmitEmpty(t *testing.T) {
	t.Parallel()
...
func RunAPIKeyJSONRoundTripWithTimestamps(t *testing.T) {
	t.Parallel()
...
func RunAuditEntryHashChainFields(t *testing.T) {
	t.Parallel()
...
func RunAuditFilterZeroValues(t *testing.T) {
	t.Parallel()
...
func RunProviderKeyJSONRoundTrip(t *testing.T) {
	t.Parallel()
	now := time.Now().UTC().Truncate(time.Second)
...
func RunAlertRuleRecordJSON(t *testing.T) {
	t.Parallel()
...
func RunAlertRecordResolvedAtOmitEmpty(t *testing.T) {
	t.Parallel()
...
func RunNotificationGroupRecordJSON(t *testing.T) {
	t.Parallel()
...
func RunWebhookEndpointRecordJSON(t *testing.T) {
	t.Parallel()
