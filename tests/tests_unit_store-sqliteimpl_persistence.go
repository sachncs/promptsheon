...
func RunRecommendationRepositoryPersists(t *testing.T) {
	db := openTestDB(t)
...
func RunLineageRepositoryPersistsGraph(t *testing.T) {
	t.Skip("lineage package removed; lineage persistence is no longer wired")
}
