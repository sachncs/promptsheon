...
func RunJSONSchema_TypeString(t *testing.T) {
...
func RunJSONSchema_TypeInteger(t *testing.T) {
...
func RunJSONSchema_Required(t *testing.T) {
...
func RunJSONSchema_PropertiesNested(t *testing.T) {
...
func RunJSONSchema_Enum(t *testing.T) {
...
func RunJSONSchema_BadSchema(t *testing.T) {
...
func RunJSONSchema_EmptySchema(t *testing.T) {
...
// RunJSONSchema_RejectsUnsupportedKeywords locks in the SEC-3a
// acceptance: a schema that uses only unsupported keywords
// (allOf, $ref, oneOf) returns errs.ErrEvalUnsupportedSchema from
// ScoreCase.
func RunJSONSchema_RejectsUnsupportedKeywords(t *testing.T) {
	cases := []struct {
		name   string
		schema string
	}{
