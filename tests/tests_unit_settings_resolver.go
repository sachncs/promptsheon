...
func RunResolver_Precedence_EnvWinsOverDB(t *testing.T) {
	t.Parallel()
...
func RunResolver_Precedence_DBIsCeiling(t *testing.T) {
	t.Parallel()
	s := &stubStore{rows: map[string]CRDTRecord{
		"otl.endpoint": {Key: "otl.endpoint", Value: "http://from-db:4317"},
	}}
...
func RunResolver_Precedence_Default(t *testing.T) {
	t.Parallel()
...
func RunResolver_DeleteReassertsEnv(t *testing.T) {
	t.Parallel()
	s := &stubStore{rows: map[string]CRDTRecord{
		"otl.endpoint": {Key: "otl.endpoint", Value: "http://from-db:4317"},
	}}
...
func RunResolver_NotifierFiresOnSet(t *testing.T) {
	t.Parallel()
	n := NewNotifier()
	var got string
...
func RunResolver_NotifierErrorPropagates(t *testing.T) {
	t.Parallel()
	n := NewNotifier()
...
// RunResolver_DeleteMissingWritesTombstone pins the new
...
func RunResolver_DeleteMissingWritesTombstone(t *testing.T) {
	t.Parallel()
	s := &stubStore{}
	r := NewResolver(s, nil, stubEnv{m: map[string]string{}}, "rep-a")
...
func RunSecretKeys(t *testing.T) {
	t.Parallel()
...
// RunResolver_ListHidesTombstones pins the Get/List
// semantics: a tombstoned row is invisible to API consumers.
func RunResolver_ListHidesTombstones(t *testing.T) {
	t.Parallel()
	ts := time.Now().UTC()
	s := &stubStore{rows: map[string]CRDTRecord{
...
// RunResolver_SetBumpsLocalVector pins the increment-on-Set
...
func RunResolver_SetBumpsLocalVector(t *testing.T) {
	t.Parallel()
	s := &stubStore{}
	r := NewResolver(s, nil, stubEnv{m: map[string]string{}}, "rep-a")
...
// RunResolver_MergeInvokesStore pins the MergeSystemConfig
// call: the Resolver forwards records to the Store.
func RunResolver_MergeInvokesStore(t *testing.T) {
	t.Parallel()
	s := &stubStore{}
	r := NewResolver(s, nil, stubEnv{m: map[string]string{}}, "rep-a")
